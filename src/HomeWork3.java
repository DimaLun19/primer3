...
static String string;
    ...
    public static String catchException(Integer integer) {try {raiseException(integer);}
    catch (SocketException socketException) {string = "SocketException";}
    catch (ClassNotFoundException classNotFoundException) {string = "ClassNotFoundException";}
    catch (AccessDeniedException accessDeniedException) {string = "AccessDeniedException";}
    catch (ExportException exportException) {string = "ExportException";}
    return string;}
